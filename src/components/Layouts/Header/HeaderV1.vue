                        ...
                        <v-container grid-list-xl>
                            <v-layout  row wrap align-center justify-space-between pa-0 ma-0>
                                ...
                                <v-flex xs6 sm6 md3 lg2 xl2 px-0>
                                    <div v-if="isAuth" class="notifications d-flex align-items-center justify-end">
                                        <emb-cart></emb-cart>
                                        <emb-wishlist></emb-wishlist>
                                        <emb-user-block></emb-user-block>
                                    </div>
                                    <div v-else class="notifications d-flex align-items-center justify-end">
                                        <router-link to="/session/signin"><h5 style="color: white" class="mb-0 font-bold">Login|</h5></router-link>
                                        <router-link to="/session/signup"><h5 style="color: white" class="mb-0 font-bold">Register</h5></router-link>
                                    </div>
                                </v-flex>
                            </v-layout>
                        </v-container>
